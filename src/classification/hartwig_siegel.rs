...
//! # References
//!
//! - Hartwig SC, Siegel J, Schneider PJ (1992). "Preventability and severity
//!   assessment in reporting adverse drug reactions." American Journal of
//!   Hospital Pharmacy 49(9):2229-2232.
...
///
/// Returns tuple of (weighted_score, max_severity, serious_count)
#[must_use]
...
mod tests {
    ...
    fn test_is_serious() {
        ...
        assert!(SeverityLevel::Moderate4.is_serious());
